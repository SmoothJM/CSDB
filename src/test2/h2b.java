...
public class h2b {
		...
		OldDBTable t1;  //stores keys with a first name and last name
		OldDBTable t2;  //stores keys with 3 additional string versions of ints
		OldDBTable t3;  //stores keys with 1 addition string version of random ints
	...
	public h2b() throws IOException {
		...
		t1 = new OldDBTable("f1", t1Fields, 5);
		t2 = new OldDBTable("f2", t2Fields, 10);
		t3 = new OldDBTable("f3", t3Fields, 6);
		...
		t1 = new OldDBTable("f1");
		t2 = new OldDBTable("f2");
		t3 = new OldDBTable("f3");
